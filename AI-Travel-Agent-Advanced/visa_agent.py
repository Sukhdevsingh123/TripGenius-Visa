...
#         """
#         Analyzes visa eligibility using the extracted IELTS PDF content.
#         """
        
#         prompt_template = """
#         You are a Senior Visa Officer and Immigration AI. 
        
#         Your Task: 
#         1. Analyze the provided IELTS Test Report Form text. Extract the Candidate Name, Overall Band Score, and individual module scores.
#         2. Evaluate Visa Eligibility for a citizen of {nationality} moving to {destination} for {purpose}.
#         3. Use the IELTS score to determine if they meet the English language requirements for this destination.
...
#         - Purpose: {purpose}
#         - Other Docs Mentioned: {additional_docs_text}
        
#         EXTRACTED PDF CONTENT (IELTS REPORT):
#         {pdf_content}
#         ---

#         Output Guidelines:
#         - If the IELTS score is high (e.g., > 7.0 for most countries), increase the eligibility score.
#         - If the score is low (< 6.0), flag it as a risk.
#         - Provide an "Admin Approval Status" indicating if you recommend this profile.

#         Output Format (JSON ONLY):
#         {{
#             "candidate_name_detected": "Name from PDF",
#             "ielts_scores_detected": {{ "Listening": "X.X", "Reading": "X.X", "Writing": "X.X", "Speaking": "X.X", "Overall": "X.X" }},
#             "eligibility_score": 85,
#             "eligibility_reason": "Explanation based on IELTS score and nationality...",
#             "admin_approval_status": "Recommended" or "Review Required" or "Rejected",
#             "missing_documents": ["List", "of", "missing", "docs"],
#             "processing_time": "e.g., 4-6 weeks"
#         }}
#         """
...
#                 "error": str(e),
#                 "eligibility_score": 0,
#                 "eligibility_reason": "AI Processing Failed",
